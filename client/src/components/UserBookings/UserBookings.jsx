    ...
    <UserNavbar />
        {
            ...
            <Row style={{marginTop:'150px'}} className='d-flex justify-content-center flex-column align-items-center w-100 h-100 '>
              ...
              {filteredBookings.map((item,index)=>{
                return(
                  ...
                  <div className="guide-packages-details">
                      ...
                      <Link to={"/guide-details/"+item.guideId?._id}><p>Guide : {item.guideId?.firstName}</p></Link>
